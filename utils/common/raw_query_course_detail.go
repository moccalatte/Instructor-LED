...
const(
	...
	GetCourseDetailById = `select * from course_detail where course_detail_id = $1 returning course_detail_id, course_id, course_chapter, course_content, created_at, updated_at, is_deleted;`
