...
const (
CreateStudent = `insert into student (fullname, birth_date, birth_place, address, education, institution, job, email, password, updated_at, is_deleted ) values ($1,$2,$3,$4,$5,46,$7,$8,$9,$10,$11) returning student_id, fullname, birth_date, birth_place, address, education, institution, job, email, password, created_at, updated_at, is_deleted;`
