...
const(
	...
	GetSessionById = `select * from session where session_id = $1 returning session_id, title, description, session_date, session_time, session_link, trainer_id, created_at, updated_at, is_deleted;`
